...
public class BDSimulado {
	...
	public BDSimulado(){
		...
		//Criando Usuarios
		Usuario u1 = new Usuario ("João da Silva","RA3534","Direito");
		...
		Bibliotecario b1 = new Bibliotecario("Marcio","12456");
		Bibliotecario b2 = new Bibliotecario("Jose","56487");
	...
	//recupera o arrylist de emprestimos
